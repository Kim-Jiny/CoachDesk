    ...
    return Scaffold(
      ...
      body: pkgState.isLoading
          ...
          : pkgState.packages.isEmpty
              ...
              : RefreshIndicator(
                  onRefresh: () => ref.read(packageProvider.notifier).fetchPackages(),
                  child: ListView(
                        ...
                        ...filteredPackages.map((pkg) {
                          return Padding(
                            ...
                            child: GestureDetector(
                              onTap: () => context.push('/packages/form', extra: pkg),
                              child: Container(
                                padding: const EdgeInsets.all(16),
                                decoration: BoxDecoration(
                                  color: Colors.white,
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Icon(
                                        ...
                                        color: pkg.isActive ? AppTheme.primaryColor : Colors.grey,
                                        size: 22,
                                      ),
                                    ),
                                    ...
                                    StatusBadge(
                                      ...
                                      color: pkg.isActive ? AppTheme.successColor : Colors.grey,
                                    ),
                                  ],
                                ),
                              ),
