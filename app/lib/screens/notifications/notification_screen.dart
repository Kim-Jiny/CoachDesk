                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isRead ? Colors.white : AppTheme.primaryColor.withValues(alpha: 0.06),
                        borderRadius: BorderRadius.circular(16),
                        boxShadow: AppTheme.softShadow,
                        border: Border.all(
                          color: isRead ? Colors.transparent : AppTheme.primaryColor.withValues(alpha: 0.12),
                        ),
                      ),
                      child: Row(
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          color: isRead ? Colors.black87 : AppTheme.primaryColor,
                                        ),
                                      ),
                                    ),
                                    if (!isRead)
                                ...
                                if (createdAt != null) ...[
                                  ...
                                  Text(
                                    DateFormat('M월 d일 HH:mm', 'ko').format(createdAt.toLocal()),
